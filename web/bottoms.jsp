<%-- 
    Document   : newjsp
    Created on : 24 Aug 2024, 9:21:18 am
    Author     : ashle
--%>
...
<head>
    ...
    <title>Thrift Shop - bottoms</title>
    <link rel="stylesheet" href="<%= request.getContextPath() %>/index.css">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/all css/bottoms.css">
        ...
        <div class="product-grid">
            ...
            %>
                                <div class="product-item">
                                    <a href="<%= request.getContextPath() %>/productdetailsBottoms.jsp?id=<%= rs.getString("id") %>">
