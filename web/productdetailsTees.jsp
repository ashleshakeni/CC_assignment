<%-- 
    Document   : productdetailsTees
    Created on : 13 Sept 2024, 8:32:17 am
    Author     : ashle
--%>
    ...
    <header>
        <div class="top-bar">
            ...
            <div class="user-actions">
                ...
                <a href="<%= request.getContextPath() %>/bag.jsp"><img src="photos/aboutus.png" alt=""/></a>
            </div>
        </div>
...
<%
    ...
    if (productId != null && !productId.trim().isEmpty()) {
        ...
        try {
            ...
            pstmt = conn.prepareStatement("SELECT * FROM tees WHERE id = ?");
