<%-- 
    Document   : hats
    Created on : 12 Sept 2024, 3:16:13 am
    Author     : ashle
--%>
    ...
    <header>
        <div class="top-bar">
            ...
            <div class="user-actions">
                ...
                <a href="<%= request.getContextPath() %>/aboutus.jsp"> <img src="photos/abutus.png" alt=""/></a>
            </div>
        </div>
        ...
        <div class="product-grid">
            ...
            %>
                                <div class="product-item">
                                    ...
                                    <a href="<%= request.getContextPath() %>/productdetailsHats.jsp?id=<%= rs.getInt("id") %>">
