<%-- 
    ...
    Created on : 8 Aug 2024, 2:36:58 pm
    Author     : ashle
--%>
...
<head>
    ...
    <title>Thrift Shop - Accessories</title>
        ...
        <div class="product-grid">
            ...
            %>
                                <div class="product-item">
                                    <!-- Image clickable, leading to product details page -->
                                    <a href="<%= request.getContextPath() %>/productdetailsAccessories.jsp?id=<%= rs.getInt("id") %>">
            ...
            <%
                    ...
                    out.println("<p>An error occurred while fetching accessories. Please try again later.</p>");
                    e.printStackTrace();
                } finally {
                    try {
                        if (rs != null) rs.close();
