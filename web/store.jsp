<%-- 
    Document   : store
    Created on : 5 Sept 2024, 1:13:29 pm
    Author     : ashle
--%>
...
<body>
    ...
    <main>
        <div class="collection-grid">
            <a href="<%= request.getContextPath() %>/womenall.jsp" class="collection-item">
                <img src="photos/womens.jpg" alt="Womens">
                <div class="caption">WOMENS</div>
            </a>
            <a href="<%= request.getContextPath() %>/menall.jsp" class="collection-item">
                <img src="photos/mens.jpg" alt="Mens">
                <div class="caption">MENS</div>
            </a>
            <a href="<%= request.getContextPath() %>/alllocal.jsp" class="collection-item">
                <img src="photos/local.jpg" alt="Local">
