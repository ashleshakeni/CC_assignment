<%-- 
    Document   : productdetailsCrochet
    Created on : 12 Sept 2024, 12:51:10 pm
    Author     : ashle
--%>
    ...
    <header>
        <div class="top-bar">
            ...
            <div class="user-actions">
                ...
                <a href="<%= request.getContextPath() %>/bag.jsp"><img src="photos/shopping-bags.png" alt=""/></a>
            </div>
        </div>
    </header>
<%
    ...
    if (productId != null && !productId.trim().isEmpty()) {
        ...
        try {
            ...
            pstmt = conn.prepareStatement("SELECT * FROM crochet WHERE id = ?");
