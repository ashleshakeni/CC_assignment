<%-- 
    Document   : summerdresses
    Created on : 12 Sept 2024, 2:41:58 am
    Author     : ashle
--%>
        ...
        <div class="product-grid">
            <%
                ...
                try {
                    ...
                    String query = "SELECT * FROM summer";
            ...
            %>
                                <div class="product-item">
                                    ...
                                    <a href="<%= request.getContextPath() %>/productdetailsSummer.jsp?id=<%= rs.getInt("id") %>">
